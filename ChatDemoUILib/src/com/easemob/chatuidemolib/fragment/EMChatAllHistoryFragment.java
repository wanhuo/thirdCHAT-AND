...
import com.easemob.chatuidemolib.adapter.ChatAllHistoryAdapter;
 ...
 * 
 */
public class EMChatAllHistoryFragment extends EMTitleBaseFragment {
	...
	protected List<EMGroup> groups;
	protected List<EMConversation> conversationList;
	protected EMChatHistoryFragmentEventListener eventListener;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				eventListener.onItemClick(conversation, position);
			}
		});
		// 注册上下文菜单
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.delete_message) {
			...
			eventListener.onContextItemSelected(item);
			// 更新消息未读数
//			((MainActivity) getActivity()).updateUnreadLabel();
	 ...
	 * @param eventListener
	 */
	public void setFragmentEventListener(EMChatHistoryFragmentEventListener eventListener){
		this.eventListener = eventListener;
	}
	
	public interface EMChatHistoryFragmentEventListener{
		/**
		 * contextmenu item被点击
		 * @param item 
		 */
		...
		/**
		 * list item点击事件
		 * @param conversation item对应的user
		 * @param position item点击位置
		 */
		void onItemClick(EMConversation conversation, int position);
	}
